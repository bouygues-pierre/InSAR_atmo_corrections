...
master = '20190908'
slave = '20190920'
date = '20190908_20211213'



def Read_Interf_cor_tiff(root_name, track, date, master, slave):

    # cath the necessary path to load datas
    dir_name_tiff = '/'.join([track, date, 'Corrected_interf'])
    file = ''.join([root_name, '/', dir_name_tiff, '/', master, '_', slave, '_', 'corrected_interf' '.tif'])
